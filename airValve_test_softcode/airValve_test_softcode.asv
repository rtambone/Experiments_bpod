function airValve_test_softcode     
...
%--- Initialize softcode handler 
BpodSystem.SoftCodeHandlerFunction= 'SoftCodeHandler_airValve'; 
...
for currentTrial = 1:MaxTrials
    currentTrialEvents= TrialManager.getCurrentEvents({'StopStimulus'});
...
sma= AddState(sma, 'Name', 'OpenAirValve',...
    ...
    'OutputActions', {'SoftCode',1, 'PWM1',255}); 

sma= AddState(sma, 'Name', 'StopStimulus',...
    'Timer', 0,...
    'StateChangeCondition', {'Tup','>exit'},...
    'OutputActions', {'SoftCode',0, 'PWM1',1}); 
end    